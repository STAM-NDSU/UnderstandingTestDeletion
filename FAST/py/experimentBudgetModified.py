...
present at https://github.com/ICSE19-FAST-R/FAST-R/blob/master/py/metric.py

This file is configured to run all FAST-R algorithms in all commits of target project in given Budget scenario(loose or strict)
"""
...
import os
import pickle
import FAST.py.fastr as fastr
import FAST.py.metric as metric
