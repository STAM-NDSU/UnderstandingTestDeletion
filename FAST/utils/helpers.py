...
from FAST.config import DELETED_TESTS_DIR
...
def get_deleted_obsolete_and_redundant_testcases_by_project_and_removedfilepath(
    ...
    # Remove "./" from filepath to match records in deltestbench csv file
    filepath_csv = filepath[2:]
    deleted_tc_with_whole_file_df = deleted_tc_commit_df[
        deleted_tc_commit_df["Filepath"] == filepath_csv
    ]
    deleted_tc_with_source_df = deleted_tc_with_whole_file_df[
        deleted_tc_with_whole_file_df["Deleted With Source Code"] == "yes"
    ]
    deleted_tc_without_source_df = deleted_tc_with_whole_file_df[
        deleted_tc_with_whole_file_df["Deleted With Source Code"] == "no"
    ]
