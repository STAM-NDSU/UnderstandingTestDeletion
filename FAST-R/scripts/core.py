...
import json
import os
from config import RESULTS_DIR, REPEATS, ARTIFACTS_DIR, BUDGET_FILE
...
def analyzer_main(prog, setting):
    ...
    for index, commit in enumerate(commits_list):
        ...
        setting_dir = (
            "loose" if setting == "loose" else "strict"
        )
        ...
        f = open(f"./{ARTIFACTS_DIR}/{setting_dir}/{prog}_analyzer.json", "w")
