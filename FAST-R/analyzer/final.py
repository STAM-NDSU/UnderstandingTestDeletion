...
from config import ARTIFACTS_DIR, PROJECTS
...
for index, project in enumerate(PROJECTS):
    loose_file = open(f"{ARTIFACTS_DIR}/loose/{project}_analyzer.json")
    strict_file = open(f"{ARTIFACTS_DIR}/strict/{project}_analyzer.json")
...
f = open(f"{ARTIFACTS_DIR}/result.json", "w")
