...
import json
import csv
from config import PROJECTS, ARTIFACTS_DIR
...
for setting in ["loose", "strict"]:
    for project in PROJECTS:
        input_file = ARTIFACTS_DIR + "/" + setting + "/" + project + "_analyzer.json"
        output_file = ARTIFACTS_DIR + "/" + setting + "/" + project + "_analyzer.csv"
